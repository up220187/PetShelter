...
router.post('/', [
    ...
    body('tipo').notEmpty().withMessage('El tipo de mascota es obligatorio'),
    body('raza').notEmpty().withMessage('La raza es obligatoria'),
    body('estadoId').isInt().withMessage('El ID del estado debe ser un número entero')
], validate,mascotaController.crearMascota);
...
], validate, mascotaController.obtenerMascotas);
...
router.put('/:id', [
    ...
    body('raza').notEmpty().withMessage('La raza es obligatoria'),
    body('estadoId').isInt().withMessage('El ID del estado debe ser un número entero')
], validate, mascotaController.actualizarMascotaPorId);
